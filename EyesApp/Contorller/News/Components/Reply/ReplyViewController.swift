...
class ReplyViewController: UIViewController {
    ...
    func callApiLoadNewsReply(newsId: String ,
        ...
        Task {
            do {
                let result: GeneralResponse<LoadNewsReplyResponse> = try await NetworkManager().requestData(method: .post,
                                                                                                            path: .loadNewsReply,
                                                                                                            parameters: request,
                                                                                                            needToken: true)
    ...
    func callApiDeleteReply(replyId: String,
        ...
        Task {
            do {
                let result: GeneralResponse<String> = try await NetworkManager().requestData(method: .post, path: .deleteReply, parameters: request, needToken: true)
    ...
    func callApiEditReply(replyId: String,
        ...
        Task {
            do {
                let result: GeneralResponse<String> = try await NetworkManager().requestData(method: .post, path: .editReply, parameters: request, needToken: true)
